...
var stringReplace_1 = require("./stringReplace");
var stringMatch_1 = require("./stringMatch");
...
var stdlibHooks = [
    ...
    math_1.math, objectKeys_1.objectKeys, objectValues_1.objectValues, toString_1.toString, stringSplit_1.stringSplit, stringStartsWith_1.stringStartsWith, stringSubstr_1.stringSubstr, stringTrim_1.stringTrim,
    stringReplace_1.stringReplace, stringMatch_1.stringMatch, arrayIsArray_1.arrayIsArray, typecastConstructors_1.typecastConstructors, parse_1.parse, hasOwnProperty_1.hasOwnProperty, json_1.json,
];
var hookStdlib = function (node, context) {
