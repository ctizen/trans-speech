...
exports.tForOfStatement = void 0;
...
function tForOfStatement(node, context) {
    ...
    var _a = __read(varsUsage_1.collectVars(function () { return renderNodes_1.renderNode(node.expression, context); }, context), 2), usedVars = _a[0], expression = _a[1];
